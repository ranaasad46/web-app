...
import leftWing from "./images/left-wing-picture.jpg";
  ...
  return (
    <div>
      <div className="page-wide">
        <div className="product-wing-left">
          <div style={{ position: "relative" }}>
            <img
              src={leftWing}
              alt="left-wing"
              style={{ height: "100vh", width: "200px", objectFit: "cover" }}
            />
            <div
              style={{
                position: "relative",
            ...
            >
              {/* <h4 className="text change">BIG SALE</h4> */}
            </div>
          </div>
        </div>
        <div className="product-wing-right">
          <div style={{ position: "relative" }}>
            <img
              src={leftWing}
              alt="left-wing"
        ...
        <div className="hot-products d-grid mt-5 mb-5 border">
          <div className="d-flex align-items-center justify-content-center font-family mb-3">
          <h1 style={{color:"Red"}}><strong> What's 20% OFF</strong></h1>
          </div>
          <div className="d-flex align-items-center justify-content-center" style={{marginLeft:"1rem"}}>
          {StoreItems.map((item) =>
            item.Sale === "Hot" ? (
              <div className="hot-product" id="hot-product1">
                <div className="product-title" style={{ marginLeft: "1px" }}>
                  {item.title}
                </div>
                ...
                <div className="product-price" style={{textDecoration:"line-through"}}>
                    {formatCurrency(item.price)}
                  </div>
                  <div className="product-price" style={{color:"orange"}}>
                    {formatCurrency(item.price*0.80)}
                  </div>
                </div>
              </div>
            ) : null
        ...
        <div className="category-product-loop my-3">
          <div className="category-products">
            {StoreItems.map((item) => (
              <div className="category-productss" key={item.id}>
